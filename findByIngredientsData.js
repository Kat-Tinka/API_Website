...
const findByIngredientsData = [
    ...
    missedIngredients: [
      {
        ...
        aisle: "Produce",
        name: "garlic",
        original: "2 bulbs garlic",
        originalName: "bulbs garlic",
        meta: [],
    ...
    usedIngredients: [
      {
        ...
        aisle: "Meat",
        name: "chicken",
        original: "1 large chicken weighing about 2.3kg",
        originalName: "chicken weighing about 2.3kg",
        meta: [],
        image:
          "https://spoonacular.com/cdn/ingredients_100x100/whole-chicken.jpg",
      },
    ...
    missedIngredients: [
      {
        ...
        original: "1 can mixed vegetables, don't drain",
        originalName: "mixed vegetables, don't drain",
        meta: ["mixed"],
        extendedName: "canned mixed vegetables",
        image:
      ...
      },
      {
        ...
        original: "1 can cream of chicken",
        originalName: "cream of chicken",
        meta: [],
        extendedName: "canned cream of chicken soup",
        image:
          "https://spoonacular.com/cdn/ingredients_100x100/cream-of-chicken-soup.jpg",
      },
      {
        id: 18010,
        amount: 1.0,
        ...
        aisle: "Baking",
        name: "bisquick",
        original: "1 cup Bisquick",
        originalName: "Bisquick",
        meta: [],
        image:
          "https://spoonacular.com/cdn/ingredients_100x100/buttermilk-biscuits.jpg",
      },
    ],
    usedIngredients: [
      {
        ...
        aisle: "Meat",
        name: "chicken",
        original: "1 can boned chicken or turkey",
        originalName: "boned chicken or turkey",
        meta: [],
    ...
    usedIngredients: [
      {
        ...
        aisle: "Meat",
        name: "chicken",
        original: "1 chicken thigh or half a spring chicken per person",
        originalName: "chicken thigh or half a spring chicken per person",
        meta: ["per person"],
        image:
          "https://spoonacular.com/cdn/ingredients_100x100/whole-chicken.jpg",
      },
  ...
  },
  {
    ...
    missedIngredients: [
      ...
      },
      {
        ...
        image:
          "https://spoonacular.com/cdn/ingredients_100x100/wonton-wrappers.jpg",
      },
    ],
    usedIngredients: [
      {
  ...
  },
  {
    ...
    image: "https://spoonacular.com/recipeImages/664206-312x231.jpg",
    imageType: "jpg",
    usedIngredientCount: 1,
    missedIngredientCount: 4,
    missedIngredients: [
      {
        ...
        originalName: "Granulated dashi tsp or Chicken broth cube-1",
        meta: [],
        image:
      ...
      },
      {
        ...
        name: "rice wine",
        original: "Hon mirin-1tbsp or Rice wine-1tbsp",
      ...
      },
      {
        ...
        aisle: "Produce",
        name: "spring onions",
        original: "Spring onions greens (chopped)-2tbsp",
        originalName: "Spring onions greens (chopped)",
        meta: ["chopped", "()"],
        image:
      ...
      },
      {
        ...
        aisle: "Ethnic Foods",
        name: "udon noodles",
        original: "Udon frozen noodles (cooked)-2cups",
        originalName: "Udon frozen noodles (cooked)",
        meta: ["frozen", "cooked", "()"],
        extendedName: "cooked frozen udon noodles",
        image:
          "https://spoonacular.com/cdn/ingredients_100x100/dry-udon-noodles.png",
      },
    ],
    usedIngredients: [
      {
        ...
        aisle: "Meat",
        name: "chicken",
        original: "Chicken boneless (cubed)-200gm",
        originalName: "Chicken boneless (cubed)",
        meta: ["boneless", "cubed", "()"],
        extendedName: "boneless chicken",
        image:
          "https://spoonacular.com/cdn/ingredients_100x100/whole-chicken.jpg",
      },
    ],
